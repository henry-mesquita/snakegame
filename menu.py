...
def show_config_menu() -> tuple[int, int, int, bool]:
    ...
    manager: pygame_gui.UIManager   = pygame_gui.UIManager(WINDOW_SIZE)
    ...
    cells_slider: UIHorizontalSlider = UIHorizontalSlider(
    ...
    running: bool       = True
    board_size: int     = int(board_slider.get_current_value())
    cell_size: int      = int(cells_slider.get_current_value())
    snake_speed: int    = int(snake_speed_slider.get_current_value())
